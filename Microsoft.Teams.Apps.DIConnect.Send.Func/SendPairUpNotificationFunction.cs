// <copyright file="SendPairUpNotificationFunction.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.DIConnect.Send.Func
{
    ...
    public class SendPairUpNotificationFunction
    {
            ...
            ILogger log)
        {
            ...
            {
                var cardJsonFilePath = Path.Combine(this.hostingEnvironment.ContentRootPath, $".\\Cards\\{PairUpNotificationCardFileName}");
